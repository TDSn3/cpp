...
/*   Updated: 2023/02/08 17:09:40 by tda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->_sign && executor.get_grade() <= this->_exec_grade)
	{
		return ;
	}
...
/* static */void	Form::ExecutionNotPossible::print_error(void)
{
	std::cout << "Execution is not possible!" << std::endl;
}
